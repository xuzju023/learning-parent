 ...
 * @Author: XuZhiJun
 * @Description:
 * @Date: Created in 16:39 2019/6/11
 */
public class JDBCConnection implements DataSource {
    ...
    private static int max = 1*jdbcConnectionInitSize; //当前最大连接数量=max*jdbcConnectionInitSize

    static {
        InputStream inputStream = JDBCConnection.class.getResourceAsStream("/application.yml");
        ...
        try{
            ...
            jdbcConnectionInitSize = Integer.valueOf((String) properties.get("jdbcConnectionInitSize"));
            //1.加载驱动程序
